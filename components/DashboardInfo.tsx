...
export default async function DashboardInfo() {
  ...
  // obtener datos procesados del backend
  const {
    totalGames,
    totalConsoles,
    gamesByConsole,
  ...
  // calcular el máximo de juegos por consola
  // esto se usa para normalizar las barras en porcentaje
    ...
    <div className="relative min-h-screen">
      ...
      <div className="relative z-10 px-4 py-6 sm:px-6 lg:px-10 text-white">
        ...
        <div className="bg-gray-900 p-4 sm:p-6 rounded-xl shadow-lg mb-8">
          ...
          {/* lista de consolas con barra de progreso */}
          {gamesByConsole.map((console) => {

            // porcentaje relativo respecto a la consola con más juegos
            const percentage =
